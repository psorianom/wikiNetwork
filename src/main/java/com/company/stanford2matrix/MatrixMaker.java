...
//                        System.out.println();
    ...
    private void prepareSemeval2007TestMatrixNPs(String pathFile) throws IOException, InvalidLengthsException {
...
//                lTargetWordInstancesMatrices.get(targetWord).put(instanceID, new JSONGraphContainer(matrixContainer));
    ...
    private void prepareSemeval2007TrainMatrixNPs(String pathFile) throws IOException, InvalidLengthsException {
        String file = readFile(pathFile, true);
