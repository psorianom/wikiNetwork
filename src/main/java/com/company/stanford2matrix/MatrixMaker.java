...
//                lTargetWordInstancesMatrices.get(targetWord).put(instanceID, new JSONGraphContainer(matrix));
            ...
            saveTextFile(this.pathFolder + "/../matrix/" + "semeval2007_" + targetWordID, sTargetWordInstancesMatrices, ".json");
            System.out.println("Done");
        }// for each targetword
    }

    private void prepareSemeval2010MatrixNPs(String pathFile) throws IOException, InvalidLengthsException {
        String file = readFile(pathFile, true);
...
//                lTargetWordInstancesMatrices.get(targetWord).put(instanceID, new JSONGraphContainer(matrix));
        ...
        Gson gson = new Gson();
            ...
            String sTargetWordInstancesMatrices = gson.toJson(lTargetWordInstancesMatrices);
        saveTextFile(this.pathFolder + "/../matrix/" + "semeval2010_" + targetWord, sTargetWordInstancesMatrices, ".json");
            System.out.println("Done");
